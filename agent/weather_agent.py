...
def get_weather(city:str):
    ...
    print("Tool Calling: get_weather",city)
...
avaiable_tools = {
    "get_weather":{
        "fn":get_weather,
        "description":"Takes a city name as an input and returns the current wheather for the city"
    }
}

system_prompt = f"""
    You are an helpfull Al Assistant who is specialized in resolving user query.
...
while True:
    ...
    while True:
        ...
        messages.append({"role": "assistant", "content":parsed_output})
